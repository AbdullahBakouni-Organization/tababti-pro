export const messages = {
  en: {
    ...
    question: {
      ...
      ALREADY_ANSWERED_BY_YOU: 'Question already answered',
    },
  ...
  ar: {
    ...
    question: {
      ...
      ANSWERED: 'تم الرد على السؤال بنجاح',
      ALREADY_ANSWERED_BY_YOU: 'تم الرد على السؤال مسبقًا',
    },
