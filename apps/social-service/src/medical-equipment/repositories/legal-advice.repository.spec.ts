...
import { LegalAdviceRepository } from './legal-advice.repository';
...
describe('LegalAdviceRepository', () => {
  let repo: LegalAdviceRepository;
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        {
          provide: getModelToken(LegalAdviceRequest.name),
          useValue: mockModel,
        },
      ],
    }).compile();

    repo = module.get<LegalAdviceRepository>(LegalAdviceRepository);
  });
