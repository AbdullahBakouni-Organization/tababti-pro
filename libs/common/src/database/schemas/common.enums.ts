...
export enum PrivateMedicineSpecialty {
  ...
  VascularSurgery = 'وعية دم',
  Endocrinology = 'غدد',
  Neurosurgery = 'دماغ ونخاع',
  GeneralDentistry = 'طب أسنان عام',
  Orthodontics = 'تقويم أسنان',
  OralMaxillofacialSurgery = 'جراحة فم ووجه وفكين',
  Endodontics = 'علاج لب السن',
  PediatricDentistry = 'طب أسنان للأطفال',
  FixedProsthodontics = 'تركيبات ثابتة',
  RemovableProsthodontics = 'تركيبات متحركة',
  Implantology = 'زراعة أسنان',
  Periodontics = 'أمراض اللثة',
  GeneralPsychiatry = 'طب نفسي عام',
  DepressionTreatment = 'علاج الاكتئاب',
  AnxietyTreatment = 'علاج القلق',
  AddictionTreatment = 'علاج الإدمان',
  ChildPsychiatry = 'طب نفسي أطفال',
  GeneralVeterinary = 'بيطري عام',
  Pets = 'حيوانات أليفة',
  Livestock = 'مواشي',
  Poultry = 'دواجن',
  InjuryTreatment = 'علاج إصابات',
  Rehabilitation = 'إعادة تأهيل',
  SportsPhysiotherapy = 'علاج رياضي',
  NeurologicalPhysiotherapy = 'علاج عصبي',
  GeriatricPhysiotherapy = 'علاج كبار السن',
}
